...
EOF1;
    ...
    $CHARACTER_IMG = $_POST['CHARACTER_IMG'];
    
    

   /* if (!empty($CHARACTER_ID)){ */
        $sql = "insert into characters (CHARACTER_ID, CHARACTER_NAME, CHARACTER_ROLE, CHARACTER_IMG)" .
                    " values (DEFAULT, '$CHARACTER_NAME', '$CHARACTER_ROLE', '$CHARACTER_IMG')";
        ...
        else
        {
            ...
            $action = 'CharactersAdm.php';
        }
   /* } 
    else
    {
        echo "Must provide a Character ID to enter a record <br>";
        $action = 'CharactersAdm.php';
    } */
