...
EOF1;
    ...
    $ROSTER_STARTDATE = $_POST['ROSTER_STARTDATE'];
    $ROSTER_ENDDATE = $_POST['ROSTER_ENDDATE'];
    

    if (!empty($ROSTER_ID)){
        $sql = "insert into roster (ROSTER_ID, PLAYER_ID, TEAM_ID, ROSTER_STARTDATE, ROSTER_ENDDATE)" .
                    " values ('$ROSTER_ID', '$PLAYER_ID', '$TEAM_ID', '$ROSTER_STARTDATE', '$ROSTER_ENDDATE')";
        ...
        else
        {
            ...
            $action = 'RosterAdm.php';
        }
    } 
    else
    {
        echo "Must provide a Roster ID to enter a record <br>";
        $action = 'RosterAdm.php';
    }
