...
if ($play_results->num_rows > 0) {
        ...
        while($rowp = $play_results->fetch_assoc()) 
        {
           
            $pla_first = "{$rowp["PLAYER_FIRSTNAME"]}";
            $pla_last = "{$rowp["PLAYER_LASTNAME"]}";
            $pla_age = "{$rowp["PLAYER_AGE"]}";
            $pla_gen = "{$rowp["PLAYER_GENDER"]}";
            $logo = "/owldb/images/";
            ...
            ++$count;
                ...
                echo "<div class=col-lg-3>";
                    echo "<div class=card>";
                    // echo '<img class="card-img-top border border-dark" src="'.$logo.$map_img.'" alt="Logo" height="250">';
                        echo "<div class=card-body>";
                        echo '<h3 class="card-title" style="text-align:center">Player Name:</h3>';
                        echo '<h4 class="bg-info card-title" style="text-align:center">'.$pla_first.' '.$pla_last.'</h4>';
                        echo "</div>";
                    echo "<ul class=list-group list-group-flush>";
                    echo '<li class="list-group-item bg-light"><h4><b>Age:</b> '.$pla_age.'</h4></li>';
                    echo '<li class="list-group-item bg-light"><h4><b>Gender:</b> '.$pla_gen.'</h4></li>';
                    echo "</ul>";
                echo "</div>";
            echo "</div>";
